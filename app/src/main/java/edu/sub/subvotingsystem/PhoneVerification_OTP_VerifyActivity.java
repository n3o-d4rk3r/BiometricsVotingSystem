...
public class PhoneVerification_OTP_VerifyActivity extends AppCompatActivity {

    private ActivityPhoneVerificationOtpVerifyBinding binding;
    private String verificationId;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityPhoneVerificationOtpVerifyBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        editTextInput();

        binding.tvMobile.setText(String.format("+88-%s", getIntent().getStringExtra("phone")));
        ...
        binding.tvResendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(PhoneVerification_OTP_VerifyActivity.this, "OTP Send Successfully.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (binding.etC1.getText().toString().trim().isEmpty() ||
                    ...
                    Toast.makeText(PhoneVerification_OTP_VerifyActivity.this, "OTP is not Valid!", Toast.LENGTH_SHORT).show();
                } else {
                        ...
                        FirebaseAuth.getInstance().signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    binding.progressBarVerify.setVisibility(View.VISIBLE);
                                    binding.btnVerify.setVisibility(View.INVISIBLE);
                                    Toast.makeText(PhoneVerification_OTP_VerifyActivity.this, "Welcome...", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(PhoneVerification_OTP_VerifyActivity.this, VoteActivity.class);
