...
public class DeleteProfileActivity extends AppCompatActivity {
                    ...
                    firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(DeleteProfileActivity.this, "Password has been verified." + "You can delete your profile now. Be careful, this action is irrevrsible", Toast.LENGTH_SHORT).show();
    ...
    private void showAlertDialog() {
        ...
        builder.setMessage("Do you really want to decide your profile and related data? This action is irrecersible~");
